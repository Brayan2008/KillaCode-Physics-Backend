...
public record UsuarioResponse(
        ...
        @Schema(description = "URL para acceder a las puntuaciones del usuario", 
                example = "http://localhost:8080/puntuaciones/usuario/1") 
...
// @formatter:on
        ...
        // Método de conversión de Usuario a UsuarioResponse
