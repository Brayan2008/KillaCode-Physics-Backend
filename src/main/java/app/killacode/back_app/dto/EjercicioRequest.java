...
public record EjercicioRequest(String id, int puntos, int nivel, String texto, String respuesta, List<String> malas) {

    public Ejercicio toEjercicio() {
        var b = new Ejercicio(id, puntos, nivel, texto, respuesta);
        if (malas != null)
            malas.forEach(mala -> {
